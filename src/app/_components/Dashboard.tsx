        ...
        <div className="container flex-1 space-y-4 py-8 pt-6">
            ...
            <Tabs defaultValue="overview">
                <TabsList>
                    ...
                    <TabsTrigger value="pastdue">Past Due Transactions</TabsTrigger>
                    <TabsTrigger value="monthlysales">Monthly Sales Overview</TabsTrigger>
                    <TabsTrigger value="monthlyrankings">
                ...
                <TabsContent value="monthlysales" className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">
                ...
                <TabsContent value="monthlyrankings" className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">
